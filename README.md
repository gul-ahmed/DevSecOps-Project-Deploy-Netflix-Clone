...
- Configure the security group to allow traffic on below ports.
- *22* for SSH
- *80* for HTTP (Web Access)
- *8081* for running the application
- *8080* for Jenkins
- *9000* for SonarQube
...
**Step 3:**
- Set up Docker and launch the application within a container.
```
sudo apt update
...
**Step 4:**
- **Get the API Key**
- Go to to TMDB (The Movie Database) website (https://www.themoviedb.org/).
- Click on "Login" and create an account.
- Go to your profile and select "Settings."
- Click on "API".
- Create a new API key by clicking "Create".
- Provide the required details and click "Submit."
- You will receive your TMDB API key.

**Step 5:**

Create the Docker image with your api key

```
docker build --build-arg TMDB_V3_API_KEY=<your-api-key> -t netflix .
```

Run the Docker conatiner out of image just created.
```
docker run -d --name netflix -p 8081:80 netflix
```
Varify the conatiner is running by accessing it though the [Public IP of EC2:8081]
...
*[Public IP of EC2:9000] (by default username & password is admin)*
...
To test trivy, scan the docker image  
```
trivy image <imageid>
```
